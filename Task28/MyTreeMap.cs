...
namespace Task27
{
    ...
    public class MyTreeMap<TKey, TValue> : MyNavigableMap<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        */
        ...
        public MyTreeMap(MyMap<TKey, TValue> m)
        {
            PutAll(m);
        }

        public MyTreeMap(MySortedMap<TKey, TValue> sm)
        {
            PutAll(sm);
        }
        ...
        MyHashMap<TKey, object> MyMap<TKey, TValue>.KeySet()
        {
        ...
        public void PutAll(MyMap<TKey, TValue> map)
        {
            foreach (KeyValuePair<TKey, TValue> item in map.EntrySet()) Put(item.Key, item.Value);
        }

        void MyMap<TKey, TValue>.Remove(object key)
        {
            throw new NotImplementedException();
        }
        ...
        bool MyMap<TKey, TValue>.ContainsValue(object value)
        {
            return ContainsValue(value);
        }

        MyHashMap<TKey, TValue> MyMap<TKey, TValue>.EntrySet()
        {
            throw new NotImplementedException();
        }
        ...
        public MyCollection<TValue> Values()
        {
            List<TValue> values = new List<TValue>();

            foreach (KeyValuePair<TKey, TValue> node in EntrySet()) values.Add(node.Value);

            return values as MyCollection<TValue>;
        }
        ...
        MyTreeMap<TKey, TValue> MySortedMap<TKey, TValue>.TailMap(TKey start)
        {
            throw new NotImplementedException();
        }
        ...
        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.FloorEntry(TKey key)
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.HigherEntry(TKey key)
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.CeilingEntry(TKey key)
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.LowerEntry(TKey key)
        {
            throw new NotImplementedException();
        }
        ...
        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.PollFirstEntry()
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.PollLastEntry()
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.FirstEntry()
        {
            throw new NotImplementedException();
        }

        Tuple<TKey, TValue> MyNavigableMap<TKey, TValue>.LastEntry()
        {
            throw new NotImplementedException();
        }
